      ...
      <div className="overflow-y-auto py-6 px-3 h-full bg-white dark:bg-gray-800">
        ...
        <div className="flex absolute bottom-0 left-0 justify-center py-6 px-2 space-x-4 w-full bg-white dark:bg-gray-800 z-20 border-r border-gray-200 dark:border-gray-700">
          <ul className="space-y-2 w-full">
            <li>
              <div className="flex items-center justify-center bg-gray-900 rounded-md p-4 gap-6 w-full">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="19"
                  height="19"
                ...
                <label className="relative inline-flex items-center cursor-pointer">
                  ...
                  <span className="hidden ml-3 text-sm font-medium text-gray-900 dark:text-gray-300">
                    Checked toggle
                  </span>
                </label>
                <svg
                ...
                >
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                    d="M14.9084 10.3674C15.3159 10.1874 15.8017 10.5324 15.6317 10.9374C14.4717 13.7124 11.6884 15.6666 8.43845 15.6666C4.14592 15.6666 0.666748 12.2574 0.666748 8.05155C0.666748 4.51072 3.13342 1.53405 6.47425 0.681553C6.90758 0.571553 7.19175 1.08822 6.95508 1.46155C6.33663 2.43569 6.00881 3.56601 6.01008 4.71989C6.01008 8.13739 8.83675 10.9074 12.3242 10.9074C13.2137 10.9089 14.0938 10.725 14.9084 10.3674ZM10.5017 1.42571C10.2075 0.984053 10.7342 0.457383 11.1759 0.752383L11.9634 1.27738C12.2827 1.49035 12.6579 1.60401 13.0417 1.60401C13.4255 1.60401 13.8007 1.49035 14.12 1.27738L14.9067 0.752383C15.3492 0.457383 15.8759 0.984053 15.5809 1.42571L15.0559 2.21321C14.8429 2.53252 14.7292 2.90773 14.7292 3.29155C14.7292 3.67536 14.8429 4.05058 15.0559 4.36988L15.5809 5.15738C15.8759 5.59905 15.3492 6.12571 14.9075 5.83071L14.12 5.30571C13.8007 5.09274 13.4255 4.97909 13.0417 4.97909C12.6579 4.97909 12.2827 5.09274 11.9634 5.30571L11.1767 5.83071C10.735 6.12571 10.2075 5.59905 10.5017 5.15738L11.0267 4.36988C11.2397 4.05058 11.3533 3.67536 11.3533 3.29155C11.3533 2.90773 11.2397 2.53252 11.0267 2.21321L10.5017 1.42571Z"
                    fill="#828FA3"
                  />
                </svg>
              </div>
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ml-3 whitespace-nowrap text-slate-400">
                  Hide Sidebar
                </span>
              </Link>
            </li>
