...
export default function Sidebar({ isSidebarOpen, toggleSidebar }: Props) {
  ...
  const sidebarClasses = isSidebarOpen ? "sidebar-open" : "sidebar-closed";
  ...
  return (
    <>
      <aside
        ...
        } bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700 ${sidebarClasses}`}
        aria-label="Sidenav"
        ...
        <div className="overflow-y-auto py-6 px-3 h-full bg-white dark:bg-gray-800">
          ...
          <div className="flex absolute bottom-0 left-0 justify-center py-6 px-2 space-x-4 w-full bg-white dark:bg-gray-800 z-20 border-r border-gray-200 dark:border-gray-700">
            <ul className="space-y-2 w-full">
              ...
              <li>
                <HideSidebar toggleSidebar={toggleSidebar} />
              </li>
            </ul>
          </div>
        </div>
