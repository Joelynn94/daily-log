...
export default function HideSidebar({ toggleSidebar }: Props) {
  return (
    <button
      className="w-full p-2 text-base font-medium text-indigo-500 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700"
    ...
    >
      <div className="flex items-center justify-start">
        ...
        <span className="ml-3 whitespace-nowrap text-slate-400">
          Hide Sidebar
        </span>
      </div>
    </button>
